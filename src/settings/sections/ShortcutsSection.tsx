  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <SectionHeader
          title={t("settingsShortcuts.shortcuts")}
          description={t("settingsShortcuts.shortcutsDescription")}
        />
        <Button
          variant="outline"
          size="sm"
      ...
      <div className="relative">
        ...
        />
        <Input
          placeholder={t("settingsShortcuts.searchPlaceholder")}
          value={search}
      ...
      <AlertDialog open={resetDialogOpen} onOpenChange={setResetDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{t("settingsShortcuts.resetAllTitle")}</AlertDialogTitle>
            <AlertDialogDescription>
              {t("settingsShortcuts.resetAllBody")}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            >
              {hasBindings ? (
                ...
                <span className="text-[11px] text-muted-foreground italic">
                  {t("settingsShortcuts.unassigned")}
                </span>
              )}
            </div>
            ...
            <div className="flex items-center gap-1">
              {isModified && (
                <Button
                  ...
                  onClick={onReset}
                  title={t("settingsShortcuts.resetToDefault")}
                >
              ...
              <Button
                ...
                onClick={onClear}
                title={t("settingsShortcuts.clearShortcut")}
              >
  ...
  return (
    <div className="flex items-center gap-2 rounded bg-accent/50 px-2 py-1 text-[11px] ring-1 ring-accent">
      <span className="animate-pulse font-medium">
        {t("settingsShortcuts.recording")}
      </span>
      <span className="text-muted-foreground">
        {t("settingsShortcuts.escToCancel")}
      </span>
    </div>
  );
}
