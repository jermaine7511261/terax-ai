  ...
  return (
    <div className="flex flex-col gap-6">
      <SectionHeader
        ...
        description={t("settingsEditor.editorDescription")}
      />

      <div className="flex flex-col gap-2">
        <Label>{t("settingsEditor.appearance")}</Label>
        <SettingRow
          title={t("settingsEditor.fontSize")}
          description={t("settingsEditor.fontSizeDescription")}
        >
          <Select
      ...
      <div className="flex flex-col gap-2">
        <Label>{t("settingsEditor.editing")}</Label>
        <SettingRow
          title={t("settingsEditor.vimMode")}
          description={t("settingsEditor.vimModeDescription")}
        >
          <Switch
            checked={vimMode}
        ...
        <SettingRow
          title={t("settingsEditor.wordWrap")}
          description={t("settingsEditor.wordWrapDescription")}
        >
          <Switch
      ...
      <div className="flex flex-col gap-2">
        <Label>{t("settingsEditor.saving")}</Label>
        <SettingRow
          title={t("settingsEditor.autoSave")}
          description={t("settingsEditor.autoSaveDescription")}
        >
          <Switch
        ...
        <SettingRow
          title={t("settingsEditor.formatOnSave")}
          description={t("settingsEditor.formatOnSaveDescription")}
        >
          <Switch
        ...
        {editorFormatOnSave && (
          <>
            <SettingRow
              title={t("settingsEditor.formatter")}
              description={t("settingsEditor.formatterDescription")}
            >
              <FormatterSelect
...
function CustomFormatCommandInput() {
  ...
  return (
    <SettingRow
      title={t("settingsEditor.customCommand")}
      description={t("settingsEditor.customCommandDescription")}
    >
      <Input
        value={draft}
...
function FormatterOverrides() {
  ...
  return (
    <>
      <SettingRow
        title={t("settingsEditor.languageOverrides")}
        description={t("settingsEditor.languageOverridesDescription")}
      >
        <button
          type="button"
      ...
      {entries.map(([lang, formatter]) => (
        ...
        >
          ...
          <button
            ...
            title={t("settingsEditor.removeOverride")}
            onClick={() => {
              const next = { ...byLang };
              delete next[lang];
              update(next);
...
function AutoSaveDelayInput({
  ...
  return (
    <SettingRow
      title={t("settingsEditor.autoSaveDelay")}
      description={t("settingsEditor.autoSaveDelayDescription")}
    >
