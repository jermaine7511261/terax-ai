...
export const zhMessages = {
  ...
  collab: {
    ...
    tabShare: "分享",
    tabWorkspaces: "工作区",
    sessionPlaceholder: "会话标题…",
    share: "分享",
    noSharedSessions: "暂无已分享会话",
    shareHint: "输入标题创建分享链接",
    copied: "已复制!",
    copyLink: "复制分享链接",
    teamWorkspaces: "团队工作区",
    newWorkspace: "新建",
    wsNamePlaceholder: "工作区名称",
    wsDescPlaceholder: "描述",
    createWorkspace: "创建",
    noWorkspaceSessions: "该工作区暂无分享的会话",
    by: "分享者",
    noWorkspaces: "暂无工作区",
    createHint: "点「新建」创建团队工作区",
    noDescription: "无描述",
    members: "位成员",
  },
  tts: {
    ...
    spoke: "已朗读 {chars} 字，耗时 {ms}ms",
    speak: "朗读",
    speaking: "朗读中…",
    noVoices: "无可用音色",
    noVoicesHint: "切换后端后刷新音色列表",
    textPlaceholder: "输入要朗读的文本…",
  },
  worktree: {
    title: "工作树快照",
    snapshot: "快照",
    diff: "对比",
    clear: "清空",
    snapshotDone: "快照已创建：{count} 个文件",
    diffDone: "对比完成：{count} 处变更",
    cleared: "已清空",
    snapshotInfo: "快照：{count} 个文件",
    recentDiff: "最近对比",
    pending: "待处理（{count}）",
    noPending: "暂无变更",
    noPendingHint: "点击「快照」记录当前状态，之后用「对比」查看变更",
  },
  codebaseGraph: {
    title: "代码图",
    index: "索引",
    indexing: "索引中…",
    indexDone: "索引完成：{count} 个文件",
    noRoot: "请先打开一个工作区",
    symbols: "符号",
    files: "文件",
    imports: "导入",
    ...
    searchDone: "找到 {count} 个符号",
    refs: "引用",
    refsPlaceholder: "查找引用…",
    refsDone: "找到 {count} 处引用",
    references: "引用",
    noSymbols: "暂无符号",
    indexHint: "点击「索引」扫描当前工作区",
    in: "位于",
  },
  search: {
    placeholder: "搜索工作区…",
  ...
  explorer: {
    ...
    partialResults: "仅显示部分结果 — 请细化查询。",
    attachToAgent: "附加到智能体",
    clickAgainToConfirm: "再次点击确认删除",
  ...
  editor: {
    ...
    overwrite: "覆盖",
    fileNotWritable: "无法确认文件状态，已取消保存",
    goToLine: "跳转到行",
    replace: "替换",
    find: "查找",
    formatFailed: "格式化失败",
    ...
    loadingDiff: "正在加载差异…",
    filenameRelativeHint: "文件名（相对工作区根目录）。扩展名决定语言模式。",
  },
  terminal: {
    search: "查找",
    copy: "复制",
    ...
    attachToAiChat: "附加到 AI 对话",
    commandCopied: "命令已复制",
    outputCopied: "输出已复制",
    blockCopied: "代码块已复制",
    browseCommandHistory: "浏览命令历史",
    autocompletePaths: "自动补全路径和命令",
    switchShellAi: "在 Shell 与 AI 之间切换",
    openAiAssistant: "打开 AI 助手",
    dropFilePathHere: "将文件路径拖到此处",
  },
  git: {
    sourceControl: "源代码管理",
    changes: "更改",
  ...
  preview: {
    ...
    bookmarks: "书签",
    noBookmarks: "还没有书签",
    xFrameHint: "许多公共网站拒绝被嵌入（X-Frame-Options）。如果页面空白，请在外部打开。",
    previewSuspended: "预览已挂起",
    releasedToFreeMemory: "在后台放置后释放内存。",
    nothingToPreview: "还没有可预览的内容",
  ...
  ai: {
    ...
    modelSwitchedToVision: "已切换视觉模型",
    modelSwitchedToVisionDesc: "当前模型不支持图像，已自动切换到支持视觉的模型。",
    placeholder:
    ...
    slash: {
      init: "初始化工作区",
      plan: "计划模式",
      "claude-code": "委派给 Claude Code",
      review: "审查当前改动",
      commit: "生成提交信息",
      test: "查找并运行相关测试",
      fix: "修复最近的错误",
      noSnippetMatches: "无匹配结果。可在 设置 → 技能 中添加片段。",
    },
    history: "对话历史",
    historySearch: "搜索对话…",
    ...
    sttLocalUnreachable: "无法连接本地 Whisper.cpp",
    sttCloudFailed: "云端转写失败",
    sttTimeout: "转写超时",
    sttUrlInvalid: "转写地址无效",
    ...
    workspaceLargeHint: "工作区较大 - 请细化查询以缩小结果范围。",
    removeCommand: "移除命令",
    removeSnippet: "移除片段",
    connectProviderHint: "连接任意 AI 提供商（或使用本地模型）——密钥保存在系统钥匙串中。",
  ...
  settingsThemes: {
    ...
    name_one_dark: "One Dark",
    desc_caffeine: "暖咖啡色调 — 奶油与浓缩咖啡。",
    desc_catppuccin: "Mocha + Latte — 柔和的粉彩。",
    desc_claude: "纸面暖陶土色点缀。",
    desc_dracula: "经典高对比紫色暗色主题。",
    desc_everforest: "柔和低对比的绿色森林调色板。",
    desc_github_dark: "GitHub 默认的暗色与亮色原色。",
    desc_gruvbox: "温暖、质朴的复古调色板。",
    desc_kanagawa_dragon: "Kanagawa 的暗哑近黑 Dragon 变体。",
    desc_kanagawa: "受葛饰北斋启发的墨色暗调；温暖的 Lotus 亮色。",
    desc_monokai: "充满活力的汽水风格调色板。",
    desc_nord: "北极蓝系调色板。",
    desc_one_dark: "Atom 的精致、内敛的暗亮双主题。",
    desc_rose_pine: "Soho 风情，天然松木与玫瑰。",
    desc_sage: "柔和森林绿 — 平静而轻柔。",
    desc_solarized: "Ethan Schoonover 的精确低眩光调色板。",
    desc_tide: "深蓝灰与柔和青色。",
    desc_tokyo_night: "宁静、偏蓝的暗色主题。",
    desc_yamet_default: "YaMet 默认外观 — 中性表面上的干净玻璃质感。",
  ...
  agents: {
    ...
    memory: "项目记忆",
    memoryHint:
      "跨会话保留的记忆条目，默认存全局 data 目录 memory.md（工作区 YaMet.md 兜底）；agent 完成任务后也会主动沉淀。",
    memoryGlobal: "全局记忆",
    memoryWorkspace: "工作区记忆",
    memoryEmpty: "还没有记忆条目。",
    memoryNoWorkspace: "无法解析记忆文件（未打开工作区且无数据目录）。",
    memoryAdd: "添加",
    memoryPlaceholder: "输入要记住的项目事实，例如：我们使用 pnpm，不用 npm。",
    memoryDelete: "删除条目",
    launchAgents: "启动智能体",
    oneWorkspaceFourPanes: "一个工作区，最多四个窗格",
    startCommand: "启动命令",
    agentAlerts: "智能体提醒",
    noAgentActivity: "暂无智能体活动",
    noAgentActivityDetail: "运行 YaMet 智能体或编码智能体会在此处跟踪。",
  },
  settingsTerminal: {
    fontFamily: "字体",
    fontSize: "字号",
  ...
  settingsLsp: {
    ...
    installManuallyHint: "请手动安装此自定义服务器，并确保其命令在 PATH 中可用。",
    stillNotFoundHint: "仍未找到。请完成安装并确保命令在 PATH 中可用。",
  },
  settingsMemory: {
    memory: "记忆",
    description:
      "控制 agent 记忆的存储、注入与自动压缩。所有配置保存在安装目录 yamet\\data 下。",
    persistentMemory: "持久记忆",
    persistentMemoryHint: "总开关：关闭后不再注入记忆，记忆工具将报「已禁用」。",
    userProfile: "用户画像",
    userProfileHint: "注入为独立 USER_PROFILE 块，让 agent 了解你的偏好与背景。",
    userProfilePlaceholder:
      "例如：我是全栈开发者，偏好中文回答，用 pnpm，不用 npm。",
    memoryProvider: "记忆提供方",
    memoryProviderHint:
      "记忆存储位置：file=数据目录 memory.md + 工作区 YaMet.md；native=Rust 三作用域 ai-memory.json；session=仅当前会话不入盘。",
    providerFile: "文件（memory.md / YaMet.md）",
    providerNative: "原生（Rust 三作用域）",
    providerSession: "仅会话（不入盘）",
    contextEngine: "上下文引擎",
    contextEngineHintFile:
      "recall=按相关性召回 top-8；full=≤8KB 全量注入；native=仅「记忆提供方=native」可用；off=不注入。",
    contextEngineHintNative: "native 引擎使用 Rust 词法打分 + 时间衰减 + MMR 召回。",
    engineRecall: "按相关性召回（top-8）",
    engineFull: "全量注入（≤8KB）",
    engineNative: "原生召回（Rust）",
    engineOff: "关闭",
    autoCompress: "自动压缩",
    autoCompressHint: "记忆条目超过压缩阈值时，最旧部分合并为一条摘要。",
    compressThreshold: "压缩阈值",
    compressThresholdHint: "条目数超过记忆上限的该比例时触发压缩（默认 0.5 = 50 条）。",
    compressTarget: "压缩目标",
    compressTargetHint: "压缩后保留记忆上限的该比例（默认 0.2 = 20 条）。",
    protectRecent: "保护最近 N 条",
    protectRecentHint: "最近 N 条记忆永不参与压缩（默认 20）。",
  },
  settingsModels: {
    models: "模型",
    description:
    ...
    localLlamaDesc: "通过 llama.cpp 的 HTTP 服务器运行本地 GGUF 模型（llama-server --port 8080）。",
    localCompatDesc: "任意 OpenAI 兼容端点（vLLM、Z.AI、Fireworks 等）。",
    localOpenrouterDesc: "OpenRouter 上的任意模型——输入完整 provider/model id。",
    baseUrl: "Base URL",
    modelId: "模型 ID",
    context: "上下文",
    tokens: "Token",
    ...
    isLoading: "加载中…",
    noPreferences: "尚未提取用户偏好——完成几次 agent 任务后会自动生成。",
    editorStyle: "编辑器风格",
    shellPreference: "Shell 偏好",
    responseStyle: "响应风格",
    commonTools: "常用工具",
    testing: "测试中…",
    ...
    pasteKey: "粘贴 API 密钥",
    clearKey: "清除密钥",
    keyConfigured: "已配置密钥（输入新值可覆盖）",
    auxModels: "分功能模型",
    auxMainModel: "使用主模型",
    auxVision: "视觉模型",
    auxWebExtract: "网页提取",
    auxCompression: "上下文压缩",
    auxSkills: "技能中心",
    auxApproval: "工具审批",
    auxMcp: "MCP",
    auxTitle: "标题生成",
    auxMaintainer: "维护器",
    auxNoLlmHint: "该功能当前沿用主模型。",
  ...
  settingsSearchProvider: {
    title: "搜索提供商密钥",
    description: "用于 web_search 的搜索 API 密钥。密钥存放在系统钥匙串中，仅供 YaMet 使用。",
    loading: "加载中…",
    configured: "已配置",
    notConfigured: "未配置",
    getKey: "获取密钥",
  ...
  settingsShortcuts: {
    ...
    clearShortcut: "清除快捷键",
    recording: "正在录制...",
        commandPalette_open: "打开命令面板",
    commandPalette_content: "在文件中查找",
    settings_open: "打开设置",
    tab_new: "新建标签页",
    tab_newBlock: "新建块状终端",
    tab_newPrivate: "新建隐私终端",
    tab_newPreview: "新建网页预览",
    tab_newEditor: "新建编辑器标签",
    tab_close: "关闭标签页或面板",
    pane_splitRight: "向右分屏",
    pane_splitDown: "向下分屏",
    pane_focusNext: "聚焦下一面板",
    pane_focusPrev: "聚焦上一面板",
    pane_swapLeft: "向左交换面板",
    pane_swapRight: "向右交换面板",
    pane_swapUp: "向上交换面板",
    pane_swapDown: "向下交换面板",
    pane_source: "切换源码面板",
    terminal_clear: "清空终端",
    terminal_toggleInput: "切换 Shell/AI 输入",
    blocks_prev: "上一命令块",
    blocks_next: "下一命令块",
    tab_next: "下一标签页",
    tab_prev: "上一标签页",
    tab_selectByIndex: "跳转到标签 1–9",
    space_next: "下一工作区",
    space_prev: "上一工作区",
    space_overview: "打开工作区",
    explorer_search: "搜索文件",
    search_focus: "在标签中查找",
    ai_toggle: "切换 AI 智能体",
    ai_toggleMini: "切换 AI 聊天窗口",
    ai_askSelection: "询问 AI 选区内容",
    agent_focusAttention: "跳转到待关注智能体",
    sidebar_toggle: "切换文件浏览器",
    explorer_focus: "切换文件浏览器焦点",
    view_zoomIn: "放大",
    view_zoomOut: "缩小",
    view_zoomReset: "重置缩放",
    view_zenMode: "切换专注模式",
    editor_undo: "撤销",
    editor_redo: "重做",
    editor_aiComplete: "触发 AI 补全",
    editor_codeComplete: "触发代码补全",
    group_ai: "AI",
    group_editor: "编辑器",
    group_general: "通用",
    group_panes: "面板",
  ...
  tool: {
    ...
    browser: "浏览器",
    computerClick: "点击",
    computerReadTree: "读屏幕树",
    computerScreenshot: "截图",
    computerType: "输入",
    debug: "调试",
    delegateMany: "并行委托",
    deleteProjectMemory: "删记忆",
    evalCode: "执行代码",
    extractUrl: "提取网页",
    github: "GitHub",
    importRules: "导入规则",
    inspectImage: "查看图片",
    listProjectMemory: "列记忆",
    lspDiagnostics: "诊断",
    lspReferences: "引用",
    lspSymbols: "符号",
    manageSkill: "管理技能",
    modelFusion: "模型融合",
    readAgentOutput: "读取输出",
    reflect: "反思",
    runGraph: "运行图",
    runScript: "运行脚本",
    sendToAgent: "发送给 agent",
    spawnCodingAgent: "编码 agent",
    ttsSpeak: "朗读",
    pdfPageCount: "PDF 页数",
  ...
  ui: {
    ...
    noDirectory: "无目录",
    shell: "Shell",
    compatPlaceholder: "任意 OpenAI 兼容端点（vLLM、Z.AI、Fireworks 等）",
    openrouterPlaceholder: "OpenRouter 上的任意模型——输入完整 provider/model id",
    modelHint: "gpt-4o、qwen3-max、glm-4.6 等",
  },
} satisfies Messages;
...
export const enMessages = {
  ...
  collab: {
    ...
    shareHint: "Enter a title to create a share link",
    copied: "Copied!",
    copyLink: "Copy share link",
    teamWorkspaces: "Team Workspaces",
    newWorkspace: "New",
    wsNamePlaceholder: "Workspace name",
    wsDescPlaceholder: "Description",
    createWorkspace: "Create",
    noWorkspaceSessions: "No sessions shared to this workspace",
    by: "By",
    noWorkspaces: "No workspaces yet",
    createHint: "Click New to create a team workspace",
  ...
  tts: {
    ...
    spoke: "Spoke {chars} chars in {ms}ms",
    speak: "Speak",
    speaking: "Speaking…",
    noVoices: "No voices available",
    noVoicesHint: "Switch backend and refresh the voice list",
  ...
  worktree: {
    ...
    diff: "Diff",
    clear: "Clear",
    snapshotDone: "Snapshot created: {count} files",
    diffDone: "Diff: {count} change(s)",
    cleared: "Cleared",
    snapshotInfo: "Snapshot: {count} files",
    recentDiff: "Recent Diff",
    pending: "Pending ({count})",
    noPending: "No pending changes",
    noPendingHint: "Snapshot to record the current state, then Diff to see changes",
  },
  codebaseGraph: {
    ...
    noRoot: "Open a workspace first",
    symbols: "Symbols",
    files: "Files",
    imports: "Imports",
    search: "Search",
    searchPlaceholder: "Search symbols…",
    searchDone: "Found {count} symbol(s)",
    refs: "Refs",
    refsPlaceholder: "Find references…",
    refsDone: "{count} reference(s) found",
    references: "References",
    noSymbols: "No symbols indexed",
    indexHint: "Click Index to scan the workspace",
    in: "in",
  },
  search: {
  ...
  editor: {
    ...
    overwrite: "Overwrite",
    fileNotWritable: "Cannot verify file status — save cancelled",
    goToLine: "Go to Line",
    replace: "Replace",
    find: "Find",
    ...
    filenameRelativeHint: "Filename (relative to workspace root). The extension determines the language mode.",
  },
  terminal: {
    search: "Find",
    copy: "Copy",
    paste: "Paste",
    writeFailed: "Failed to write to terminal",
    ...
    autocompletePaths: "Autocomplete paths and commands",
    switchShellAi: "Switch between Shell and AI",
    openAiAssistant: "Open the AI assistant",
    dropFilePathHere: "Drop file path here",
  },
  git: {
    sourceControl: "Source Control",
    changes: "Changes",
    ...
    repoHasSubmodules: "Repository has submodules",
    stashAllChanges: "Stash all changes",
    noStashesYet: "No stashes yet.",
    openDiff: "Open Diff",
  ...
  preview: {
    ...
    xFrameHint: "Many public sites refuse to embed (X-Frame-Options). If the page is blank, open it externally.",
    previewSuspended: "Preview suspended",
    releasedToFreeMemory: "Released to free memory after sitting in the background.",
  ...
  ai: {
    ...
    modelSwitchedToVision: "Switched to a vision model",
    modelSwitchedToVisionDesc:
      "The current model cannot see images, so a vision-capable model was selected automatically.",
    placeholder:
    ...
    slash: {
      ...
      noSnippetMatches: "No matches. Add snippets in Settings → Skills.",
    },
    ...
    sttLocalUnreachable: "Cannot reach local Whisper.cpp",
    sttCloudFailed: "Cloud transcription failed",
    sttTimeout: "Transcription timed out",
    sttUrlInvalid: "Invalid transcription URL",
    ...
    continue: "Continue",
    editsSnapshot: "AI changed {n} file(s)",
    rollback: "Roll back",
    ...
    workspaceLargeHint: "Workspace is large - refine your query to narrow results.",
    removeCommand: "Remove command",
    removeSnippet: "Remove snippet",
    connectProviderHint: "Connect any AI provider (or use local models) - your key stays in your OS keychain.",
  ...
  agents: {
    ...
    memoryHint:
      "Memory entries kept across sessions — stored in the global data-dir memory.md by default (workspace YaMet.md as fallback); the agent also settles findings proactively.",
    memoryGlobal: "Global memory",
    memoryWorkspace: "Workspace memory",
    memoryEmpty: "No memory entries yet.",
    memoryNoWorkspace: "Cannot resolve a memory file (no workspace open and no data dir).",
    memoryAdd: "Add",
    memoryPlaceholder:
      "Enter a project fact to remember, e.g. We use pnpm, never npm.",
    memoryDelete: "Delete entry",
    launchAgents: "Launch agents",
    oneWorkspaceFourPanes: "One workspace, up to four panes",
    startCommand: "Start command",
    agentAlerts: "Agent alerts",
    noAgentActivity: "No agent activity yet.",
    noAgentActivityDetail: "Run the YaMet agent or a coding agent to track it here.",
  },
  updater: {
  ...
  settingsGeneral: {
    appearance: "Appearance",
    adhdFormatting:
      "Format replies: action-first, numbered steps, restate status each turn, no preamble",
  ...
  settingsThemes: {
    ...
    name_one_dark: "One Dark",
    desc_caffeine: "Warm coffee tones — cream and espresso.",
    desc_catppuccin: "Mocha + Latte — soothing pastel.",
    desc_claude: "Warm clay accent on paper.",
    desc_dracula: "The classic high-contrast purple dark theme.",
    desc_everforest: "Soft, low-contrast green forest palette.",
    desc_github_dark: "GitHub's default dark and light primitives.",
    desc_gruvbox: "Warm, earthy retro palette.",
    desc_kanagawa_dragon: "The muted, near-black Dragon variant of Kanagawa.",
    desc_kanagawa: "Inky dark inspired by Hokusai; warm Lotus light.",
    desc_monokai: "Vibrant soda-pop inspired palette.",
    desc_nord: "Arctic, north-bluish palette.",
    desc_one_dark: "Atom's sleek, subdued dark and light duo.",
    desc_rose_pine: "Soho vibes, all-natural pine and rose.",
    desc_sage: "Muted forest green — calm and soft.",
    desc_solarized: "Ethan Schoonover's precision low-glare palette.",
    desc_tide: "Deep slate with muted teal.",
    desc_tokyo_night: "Calm, blue-leaning dark theme.",
    desc_yamet_default: "The default YaMet look — clean glass over neutral surfaces.",
  ...
  settingsLsp: {
    ...
    installManuallyHint: "Install this custom server manually and make sure its command is available on PATH.",
    stillNotFoundHint: "Still not found. Finish the installation and make sure the command is available on PATH.",
  },
  settingsMemory: {
    memory: "Memory",
    description:
      "Control where the agent's memory is stored, how it is injected, and auto-compression. All settings persist under the install dir yamet\\data.",
    persistentMemory: "Persistent memory",
    persistentMemoryHint:
      "Master switch: when off, memory is not injected and memory tools report disabled.",
    userProfile: "User profile",
    userProfileHint:
      "Injected as a dedicated USER_PROFILE block so the agent knows your preferences and background.",
    userProfilePlaceholder:
      "e.g. I'm a full-stack developer, prefer Chinese answers, use pnpm (never npm).",
    memoryProvider: "Memory provider",
    memoryProviderHint:
      "Where memory lives: file = data-dir memory.md + workspace YaMet.md; native = Rust three-scope ai-memory.json; session = current session only, no disk.",
    providerFile: "File (memory.md / YaMet.md)",
    providerNative: "Native (Rust 3-scope)",
    providerSession: "Session only (no disk)",
    contextEngine: "Context engine",
    contextEngineHintFile:
      "recall = top-8 by relevance; full = inject everything (≤8KB); native = Rust recall (only when provider is native); off = don't inject.",
    contextEngineHintNative:
      "The native engine uses lexical scoring + time decay + MMR.",
    engineRecall: "Relevance recall (top-8)",
    engineFull: "Full injection (≤8KB)",
    engineNative: "Native recall (Rust)",
    engineOff: "Off",
    autoCompress: "Auto-compression",
    autoCompressHint:
      "When memory entries exceed the compression threshold, the oldest share merges into a single summary.",
    compressThreshold: "Compression threshold",
    compressThresholdHint:
      "Trigger compression when entries exceed this ratio of the memory cap (default 0.5 = 50 entries).",
    compressTarget: "Compression target",
    compressTargetHint:
      "Settle at this ratio of the memory cap after compression (default 0.2 = 20 entries).",
    protectRecent: "Protect recent N",
    protectRecentHint:
      "The N most recent entries never participate in compression (default 20).",
  },
  settingsModels: {
    models: "Models",
    description:
    ...
    openaiCompatible: "OpenAI Compatible",
    compatEndpoints: "Custom endpoints",
    defaults: "Defaults",
    ...
    localLlamaDesc: "Local GGUF models via llama.cpp's HTTP server (llama-server --port 8080).",
    localCompatDesc: "Any OpenAI-compatible endpoint — vLLM, Z.AI, Fireworks, etc.",
    localOpenrouterDesc: "Any model on OpenRouter — type its full provider/model id.",
    baseUrl: "Base URL",
    modelId: "Model ID",
    context: "Context",
    tokens: "tokens",
    ...
    isLoading: "Loading…",
    noPreferences: "No user preferences yet. They build up automatically after a few agent runs.",
    editorStyle: "Editor style",
    shellPreference: "Shell preference",
    ...
    clearKey: "Clear key",
    keyConfigured: "Key configured (enter a new value to replace)",
    auxModels: "Per-feature models",
    auxMainModel: "Use main model",
    auxVision: "Vision",
    auxWebExtract: "Web extraction",
    auxCompression: "Context compression",
    auxSkills: "Skills center",
    auxApproval: "Tool approval",
    auxMcp: "MCP",
    auxTitle: "Title generation",
    auxMaintainer: "Maintainer",
    auxNoLlmHint: "This feature currently follows the main model.",
  ...
  settingsSearchProvider: {
    title: "Search provider keys",
    description:
      "Search API keys used by web_search. Keys live in your OS keychain and are used only by YaMet.",
    loading: "Loading…",
  ...
  tool: {
    ...
    suggestCommand: "Suggest command",
    terminalOutput: "Terminal output",
    terminalExecute: "Run in terminal",
    terminalType: "Type in terminal",
    preview: "Preview",
    subagent: "Subagent",
    handoff: "Handoff",
    ...
    createDocx: "Create Word",
    createXlsx: "Create Excel",
    createPptx: "Create PPT",
    ...
    browser: "Browser",
    computerClick: "Click",
    computerReadTree: "Read screen tree",
    computerScreenshot: "Screenshot",
    computerType: "Type",
    debug: "Debug",
    delegateMany: "Delegate many",
    deleteProjectMemory: "Delete memory",
    evalCode: "Eval code",
    extractUrl: "Extract URL",
    github: "GitHub",
    importRules: "Import rules",
    inspectImage: "Inspect image",
    listProjectMemory: "List memory",
    lspDiagnostics: "Diagnostics",
    lspReferences: "References",
    lspSymbols: "Symbols",
    manageSkill: "Manage skill",
    modelFusion: "Model fusion",
    readAgentOutput: "Agent output",
    reflect: "Reflect",
    runGraph: "Run graph",
    runScript: "Run script",
    sendToAgent: "Send to agent",
    spawnCodingAgent: "Coding agent",
    ttsSpeak: "Speak",
  ...
  ui: {
    ...
    emptyBody: "Start a conversation to see messages here",
    askYaMet: "Ask YaMet",
    refresh: "Refresh",
    gitGraph: "Git graph",
    toCommit: "to commit",
    ...
    shell: "Shell",
    compatPlaceholder: "Any OpenAI-compatible endpoint (vLLM, Z.AI, Fireworks, etc.)",
    openrouterPlaceholder: "Any model on OpenRouter — type its full provider/model id.",
    modelHint: "gpt-4o, qwen3-max, glm-4.6, ...",
  },
} satisfies Messages;
