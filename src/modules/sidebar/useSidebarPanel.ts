...
function readSidebarView(): SidebarViewId {
  try {
    ...
    if (stored === "explorer" || stored === "source-control" || stored === "memory" || stored === "skills" || stored === "cron" || stored === "profile" || stored === "honcho" || stored === "snapshot" || stored === "gateway") return stored;
  } catch {
    // ignore
  }
  return "explorer";
