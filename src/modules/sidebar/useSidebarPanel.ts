...
const SIDEBAR_WIDTH_STORAGE_KEY = "yamet.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "yamet.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "yamet.sidebar.collapsed";
