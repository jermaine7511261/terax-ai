                        ...
                        >
                          ...
                          >
                            ...
                            <div className="flex flex-1 flex-col">
                              <span>{translate("editor.autoDetect")}</span>
                              <span className="text-[10px] text-muted-foreground italic">
                                {translate("editor.mode", {
                                  lang: resolveDisplayName(t.title),
                                })}
                              </span>
                            </div>
                          ...
                          >
                            {showAllLanguages
                              ? translate("editor.fewerLanguages")
                              : translate("editor.allLanguages")}
                          </DropdownMenuItem>
                    ...
                    >
                      ...
                      >
                        <HugeiconsIcon
                          ...
                          strokeWidth={1.75}
                        />
                        <span className="flex-1">{translate("tabs.rename")}</span>
                      </ContextMenuItem>
                      {tabs.length > 1 && (
                        <>
                          <ContextMenuSeparator />
                          ...
                          >
                            <HugeiconsIcon
                              ...
                              strokeWidth={1.75}
                            />
                            <span className="flex-1">{translate("tabs.closeThis")}</span>
                          </ContextMenuItem>
                        </>
                      )}
                    </ContextMenuContent>
