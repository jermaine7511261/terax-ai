...
const LAST_CHECK_KEY = "yamet:updater:last-check";
const CHECK_INTERVAL_MS = 30 * 60 * 1000;
// Point this at your fork's releases page once published (e.g.
// "https://api.github.com/repos/<owner>/yamet/releases/latest").
