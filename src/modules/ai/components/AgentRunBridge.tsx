...
function Bridge({
  ...
  useEffect(() => {
    ...
    // While auto-approving, don't open review tabs for new approvals.
    if (autoApproveArmed) return;
  ...
  }, [messages, fileMutationFingerprint, openAiDiffTab, closeAiDiffTab, autoApproveArmed]);
