...
export const TOGGLE_BLOCK_INPUT_EVENT = "yamet:toggle-block-input";
...
export function WorkspaceInputBar({
  ...
  const mounted = keysLoaded || isBlockTab || isChatTab;
  const open = isChatTab || isBlockTab || (keysLoaded && panelOpen);
