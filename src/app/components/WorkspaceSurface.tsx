...
// Lazy: the AI stack must stay out of the eager startup graph (bundle budget).
const AiChatPanel = lazy(() =>
  import("@/modules/ai/components/AiChatPanel").then((m) => ({
...
export function WorkspaceSurface({
  ...
  return (
    <div className="relative h-full min-h-0">
      <div
        className={cn(
          "absolute inset-0 px-4 pt-3 pb-2",
          !isChatTab && "invisible pointer-events-none",
        )}
